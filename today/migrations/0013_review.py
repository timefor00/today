# Generated by Django 3.1.2 on 2020-11-19 04:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='studio_review', to='today.product')),
            ],
            options={
                'ordering': ['-updated'],
            },
